...
\begin{tcolorbox}[colback = purple!20!white, colframe = purple!60!white, title = Lemme 2]
    Soit $\gamma$ un chemin à retours finis. Soit $B$ un ouvert d'adhérence isomorphe à la boule fermée,
    tel qu'il existe $x \in \operatorname{Fr}(B)$ et $(\varepsilon_n)$ de limite nulle telle que
    \[ \forall n \in \mathbb{N}, \mathcal{B}(x, \varepsilon_n) \cap B \cap \gamma \neq \varnothing\]
    On suppose enfin que $B \backslash \gamma$ n'est pas connexe par arcs.\\
    Alors il existe $I \subset [0, 1]$ un intervalle fermé vérifiant
    \begin{itemize}
        \item $x \in \gamma(I)$
        \item $\gamma(I)$ sépare $B$ en deux ouverts d'adhérence homéomorphes à des boules fermées
    \end{itemize}
\end{tcolorbox}

\begin{tcolorbox}[colback = purple!20!white, colframe = purple!60!white, title = Lemme 3]
