...
\begin{tcolorbox}[colback = purple!20!white, colframe = purple!60!white, title = Lemme 2]
    Soit $B$ un ouvert tel que $\overline{B} \cong \mathcal{B}_f(0, 1)$, $\gamma$ un
    chemin à retours finis et $x \in \operatorname{Fr}(B)$ tels qu'il existe $(\varepsilon_n)$,
    $\varepsilon_n \rightarrow 0$, telle que pour tout $n \in \mathbb{N}$,
    $\mathcal{B}(x, \varepsilon_n) \cap B \backslash \gamma$ ne soit pas connexe par arcs. 
